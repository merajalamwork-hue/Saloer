...
### TC-024: Select a Shipping Method
- **Precondition:** Shipping address step is complete
- **Steps:**
  1. Observe available shipping methods
  2. Select one (e.g., "Standard Shipping")
  3. Click Continue
- **Expected Result:** Shipping method is selected and order summary updates with shipping cost
- **Status:** [ ] Pass  [ ] Fail

---

### TC-025: Verify Shipping Cost in Order Summary
...
### TC-026: Payment Section Loads
- **Precondition:** Shipping method step is complete
- **Steps:**
  1. Proceed to the payment step
  2. Observe available payment options
- **Expected Result:** Payment section loads with at least one payment method (e.g., credit card via Stripe/Adyen dummy)
- **Status:** [ ] Pass  [ ] Fail

---

### TC-027: Enter Valid Dummy Card Details
- **Precondition:** Payment step is open; test card details are available
- **Steps:**
  1. Enter test card number: `4242 4242 4242 4242`
  2. Expiry: `12/30`
  3. CVC: `123`
  4. Click "Pay" / "Place Order"
- **Expected Result:** Payment is processed; order confirmation page is displayed with an order number
- **Status:** [ ] Pass  [ ] Fail

---

### TC-028: Enter Invalid Card Number
- **Precondition:** Payment step is open
- **Steps:**
  1. Enter an invalid card number: `1234 5678 9012 3456`
  2. Enter valid expiry and CVC
  3. Click "Pay"
- **Expected Result:** Payment fails with an appropriate error message (e.g., "Your card number is incorrect")
- **Status:** [ ] Pass  [ ] Fail

---

### TC-029: Enter Expired Card
- **Precondition:** Payment step is open
- **Steps:**
  1. Enter card number: `4242 4242 4242 4242`
  2. Expiry: `01/20` (past date)
  3. CVC: `123`
  4. Click "Pay"
- **Expected Result:** Error message shown: "Your card has expired" or similar
- **Status:** [ ] Pass  [ ] Fail

---

## TEST SUITE 9: Order Confirmation

### TC-030: Order Confirmation Page
- **Precondition:** Payment was successfully placed (TC-027 passed)
- **Steps:**
  1. Observe the page after successful payment
- **Expected Result:** Confirmation page shows order number, summary of items, shipping address, and a thank-you message
- **Status:** [ ] Pass  [ ] Fail

---

### TC-031: Confirmation Email (Visual Check)
- **Precondition:** Order placed with a real/test email
- **Steps:**
  1. Check the inbox of the email used during checkout
- **Expected Result:** A confirmation email is received with order details
- **Status:** [ ] Pass  [ ] Fail

---

## TEST SUITE 10: Edge Cases & Negative Tests
...
### TC-033: Navigate Back During Checkout
...
### TC-034: Checkout with Empty Cart
...
### TC-035: Responsiveness on Mobile View
...
| TC-025 | Verify Shipping Cost in Order Summary     | Medium   |        |
| TC-026 | Payment Section Loads                     | High     |        |
| TC-027 | Enter Valid Dummy Card Details            | High     |        |
| TC-028 | Enter Invalid Card Number                 | High     |        |
| TC-029 | Enter Expired Card                        | High     |        |
| TC-030 | Order Confirmation Page                   | High     |        |
| TC-031 | Confirmation Email                        | Medium   |        |
| TC-032 | Add Out-of-Stock Product to Cart          | Medium   |        |
| TC-033 | Navigate Back During Checkout             | Medium   |        |
| TC-034 | Checkout with Empty Cart                  | Medium   |        |
| TC-035 | Responsiveness on Mobile View             | High     |        |
